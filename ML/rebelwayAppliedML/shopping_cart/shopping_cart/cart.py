...
class Cart:
    ...
    def get_all_items(self,verbose=0)->dict:
        ...
        try:
            ...
            raise ValueError("verbose的值必须是0 or 1")
    ...
    def remove_items_from_cart_by_query(self,query:str):
        ...
        for item_id in items_to_remove:
            ...
            print(f"Remove {item_name} from the cart.")
    ...
    def remove_items_from_cart_by_selection(self):
        ...
        for item_id,item_data in data["Items"].items():
            ...
            i+=1
        try:
            usr_choice = int(input("Select the item to delete by number,example:"))-1
        except:
            raise ValueError("Must select a valid number!")
